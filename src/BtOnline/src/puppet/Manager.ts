...
export class PuppetManager {
    ...
    changePuppetScene(nplayer: INetworkPlayer, scene: number) {
        ...
        this.log('Puppet moved to scene[' + puppet.scene.toString(16) + ']');
    }
    ...
    handleNewPlayers() {
        ...
        this.mapi.clientSide.sendPacket(new Packet('Request_Scene', 'BtOnline', this.mapi.clientLobby, true));
    }
